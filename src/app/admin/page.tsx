...
const qualityPackagingPageFields = [
  ...
  { section: 'Standards', key: 'item3', val: 'In-process quality monitoring', limit: 60 },
...
export default function AdminDashboard() {
  ...
  const syncInitialData = async () => {
    ...
    try {
      ...
      const initialContent = [
        ...
        { page: 'about', section: 'Merchant Exporter', key: 'title', val: 'Merchant Exporter + Sourcing Partner' },
        { page: 'about', section: 'Merchant Exporter', key: 'subtitle', val: "We don't just facilitate exports—we actively source products on your behalf, ensuring quality, compliance, and timely delivery." },
        { page: 'about', section: 'Merchant Exporter', key: 'col1_title', val: 'As Your Sourcing Partner' },
        { page: 'about', section: 'Merchant Exporter', key: 'col1_item1', val: 'Identify and vet manufacturers based on your requirements' },
        { page: 'about', section: 'Merchant Exporter', key: 'col1_item2', val: 'Negotiate pricing and terms on your behalf' },
        { page: 'about', section: 'Merchant Exporter', key: 'col1_item3', val: 'Arrange samples and conduct quality inspections' },
        { page: 'about', section: 'Merchant Exporter', key: 'col1_item4', val: 'Custom sourcing for specialized products' },
        { page: 'about', section: 'Merchant Exporter', key: 'col2_title', val: 'As Merchant Exporter' },
        { page: 'about', section: 'Merchant Exporter', key: 'col2_item1', val: 'Handle all export documentation and compliance' },
        { page: 'about', section: 'Merchant Exporter', key: 'col2_item2', val: 'Manage customs clearance and shipping logistics' },
        { page: 'about', section: 'Merchant Exporter', key: 'col2_item3', val: 'Provide certificates (COO, Phytosanitary, FSSAI, etc.)' },
        { page: 'about', section: 'Merchant Exporter', key: 'col2_item4', val: 'Ensure timely, safe delivery to global destinations' },

        { page: 'about', section: 'Linear', key: 'title', val: 'Backed by Linear Global Credibility' },
        { page: 'about', section: 'Linear', key: 'desc', val: 'Our partnership with Linear Global gives us access to world-class logistics infrastructure, ensuring your shipments are handled with expertise and care.' },
        ...
        { page: 'about', section: 'Why Choose Us', key: 'item1_desc', val: 'Access to suppliers across agro, packaging, industrial, chemicals, consumer goods, and more' },
        { page: 'about', section: 'Why Choose Us', key: 'item2_title', val: 'Export Expertise' },
        { page: 'about', section: 'Why Choose Us', key: 'item2_desc', val: 'Complete knowledge of international trade compliance and documentation' },
        { page: 'about', section: 'Why Choose Us', key: 'item3_title', val: 'Verified Manufacturers' },
        { page: 'about', section: 'Why Choose Us', key: 'item3_desc', val: 'Pre-vetted, certified suppliers with proven track records' },
        { page: 'about', section: 'Why Choose Us', key: 'item4_title', val: 'Quality Control' },
        { page: 'about', section: 'Why Choose Us', key: 'item4_desc', val: 'Rigorous inspection protocols at every stage' },
        { page: 'about', section: 'Why Choose Us', key: 'item5_title', val: 'Packaging Solutions' },
        { page: 'about', section: 'Why Choose Us', key: 'item5_desc', val: 'Export-grade packaging tailored to your product needs' },
        { page: 'about', section: 'Why Choose Us', key: 'item6_title', val: 'Logistics Support' },
        { page: 'about', section: 'Why Choose Us', key: 'item6_desc', val: 'End-to-end shipping backed by Linear Global' },

        { page: 'about', section: 'CTA', key: 'title', val: 'Talk to Our Sourcing Team' },
        { page: 'about', section: 'CTA', key: 'desc', val: 'Share your requirement and get a practical sourcing roadmap.' },
        { page: 'about', section: 'CTA', key: 'btn_text', val: 'Contact Us' },
        ...
        { page: 'contact', section: 'Info', key: 'title', val: 'Company Information' },
        { page: 'contact', section: 'Info', key: 'company_name', val: 'ABC International' },
        { page: 'contact', section: 'Info', key: 'label_email', val: 'Email' },
        { page: 'contact', section: 'Info', key: 'email', val: 'info@abc-international.co.in' },
        { page: 'contact', section: 'Info', key: 'label_phone', val: 'Phone' },
        { page: 'contact', section: 'Info', key: 'phone', val: '+91 XXXX XXXXXX' },
        { page: 'contact', section: 'Info', key: 'label_address', val: 'Address' },
        { page: 'contact', section: 'Info', key: 'address', val: 'Mumbai, Maharashtra, India' },
        { page: 'contact', section: 'Reasons', key: 'title', val: 'Why Contact Us?' },
        { page: 'contact', section: 'Reasons', key: 'item1', val: 'Get personalized sourcing recommendations' },
        { page: 'contact', section: 'Reasons', key: 'item2', val: 'Receive competitive pricing quotes' },
        { page: 'contact', section: 'Reasons', key: 'item3', val: 'Discuss logistics and shipping options' },
        { page: 'contact', section: 'Reasons', key: 'item4', val: 'Learn about compliance requirements' },
        { page: 'contact', section: 'Reasons', key: 'item5', val: 'Schedule factory visits and inspections' },
        { page: 'contact', section: 'Stats', key: 'title', val: 'Quick Response Guarantee' },
        { page: 'contact', section: 'Stats', key: 'desc', val: 'Our sourcing team typically responds to inquiries within 24 hours during business days.' },
        ...
        { page: 'contact', section: 'Form', key: 'submitting_text', val: 'Submitting...' },
        { page: 'contact', section: 'Form', key: 'success_message', val: 'Thank you! Your inquiry has been successfully sent. We will get back to you shortly.' },
        { page: 'contact', section: 'Form', key: 'recaptcha_text', val: 'Protected by Google reCAPTCHA.' },
      ...
      if (result.success) {
        ...
        // Create a sample blog if the table is empty
        const { data: blogCheck } = await supabase.from('blogs').select('id').limit(1);
  ...
  const toggleVisibility = async (type: 'industries' | 'products' | 'blogs', id: string, currentStatus: boolean) => {
    ...
    if ((type === 'industries' || type === 'products') && isEnglish) {
      const action = currentStatus ? 'hide' : 'show';
      if (!confirm(`Are you sure you want to ${action} this ${type === 'industries' ? 'industry' : 'product'}? This will also ${action} ALL its translations.`)) return;
    }
  ...
  const deleteItem = async (type: 'industries' | 'products' | 'blogs', id: string) => {
    let confirmMessage = 'Are you sure you want to delete this item? This cannot be undone.';
    const isEnglish = !id.includes(':') || id.startsWith('en:');
    
    if ((type === 'industries' || type === 'products') && isEnglish) {
        confirmMessage = `Are you sure you want to delete this ${type === 'industries' ? 'industry' : 'product'}? This will also delete ALL its translations. This cannot be undone.`;
    }
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            {activeTab !== 'industries-content' && (() => {
              ...
              const sectionOrder: Record<string, string[]> = {
                ...
                'about': ['Hero', 'Who We Are', 'Main', 'Merchant Exporter', 'Linear', 'Approach', 'Why Choose Us', 'CTA'],
                'contact': ['Hero', 'Form', 'Info', 'Reasons', 'Stats'],
