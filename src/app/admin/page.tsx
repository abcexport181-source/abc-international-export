...
export default function AdminDashboard() {
  ...
  const getCharLimit = (text: string) => Math.max(text.length * 2, 40);
  ...
  const syncInitialData = async () => {
    ...
    try {
      ...
      const initialContent = [
        // HOME PAGE
        { page: 'home', section: 'Hero', key: 'title', val: 'Your Trusted Merchant Exporter from India', limit: 80 },
        { page: 'home', section: 'Hero', key: 'desc', val: 'Global sourcing expertise backed by comprehensive logistics support.', limit: 120 },
        
        { page: 'home', section: 'Who We Are', key: 'title', val: 'Who We Are', limit: 40 },
        { page: 'home', section: 'Who We Are', key: 'p1', val: 'ABC International is a trusted merchant exporter and comprehensive sourcing partner based in India.', limit: 200 },
        ...
        { page: 'home', section: 'Services', key: 'title', val: 'What We Do', limit: 40 },
        { page: 'home', section: 'Services', key: 's1_title', val: 'Product Sourcing', limit: 40 },
        { page: 'home', section: 'Services', key: 's1_desc', val: 'Comprehensive sourcing from verified Indian manufacturers', limit: 120 },
        { page: 'home', section: 'Services', key: 's2_title', val: 'Global Export', limit: 40 },
        { page: 'home', section: 'Services', key: 's2_desc', val: 'Seamless export services to markets worldwide', limit: 120 },
        { page: 'home', section: 'Services', key: 's3_title', val: 'Quality Control', limit: 40 },
        { page: 'home', section: 'Services', key: 's3_desc', val: 'Rigorous inspection and verification processes', limit: 120 },
        { page: 'home', section: 'Services', key: 's4_title', val: 'Logistics Support', limit: 40 },
        { page: 'home', section: 'Services', key: 's4_desc', val: 'End-to-end logistics and documentation expertise', limit: 120 },

        { page: 'home', section: 'Logistics', key: 'title', val: 'Logistics Expertise That Sets Us Apart', limit: 80 },
        { page: 'home', section: 'Logistics', key: 'desc', val: "With Linear Global's proven logistics network, we handle every aspect of export logistics—from documentation to customs clearance to final delivery.", limit: 300 },
        { page: 'home', section: 'Logistics', key: 'item1', val: 'Complete export documentation (COO, certificates, etc.)', limit: 100 },
        { page: 'home', section: 'Logistics', key: 'item2', val: 'Air and sea freight management', limit: 100 },
        { page: 'home', section: 'Logistics', key: 'item3', val: 'Customs compliance and clearance', limit: 100 },

        { page: 'home', section: 'Sourcing', key: 'title', val: 'Comprehensive Sourcing Capability', limit: 80 },
        { page: 'home', section: 'Sourcing', key: 'desc', val: 'We source a wide range of products, raw materials, and packaging solutions from India\'s most reliable manufacturers.', limit: 200 },

        { page: 'home', section: 'Quality', key: 'title', val: 'Quality Assurance & Export Packaging', limit: 80 },
        { page: 'home', section: 'Quality', key: 'desc', val: 'We ensure every product meets international standards with rigorous quality control and professional export-grade packaging.', limit: 250 },
        { page: 'home', section: 'Quality', key: 'item1_title', val: 'Quality Inspection', limit: 40 },
        { page: 'home', section: 'Quality', key: 'item1_desc', val: 'Pre-shipment inspection, sample approval, and supplier verification', limit: 120 },
        { page: 'home', section: 'Quality', key: 'item2_title', val: 'Export Packaging', limit: 40 },
        { page: 'home', section: 'Quality', key: 'item2_desc', val: 'Professional packaging solutions for safe international transit', limit: 120 },
        { page: 'home', section: 'Quality', key: 'item3_title', val: 'Compliance', limit: 40 },
        { page: 'home', section: 'Quality', key: 'item3_desc', val: 'Country-specific labeling and regulatory compliance', limit: 120 },

        { page: 'home', section: 'Process', key: 'title', val: 'How We Work', limit: 40 },
        { page: 'home', section: 'Process', key: 'step1_title', val: 'Requirement Analysis', limit: 40 },
        { page: 'home', section: 'Process', key: 'step1_desc', val: 'We understand your specific needs', limit: 100 },
        { page: 'home', section: 'Process', key: 'step2_title', val: 'Supplier Matching', limit: 40 },
        { page: 'home', section: 'Process', key: 'step2_desc', val: 'Connect with verified manufacturers', limit: 100 },
        { page: 'home', section: 'Process', key: 'step3_title', val: 'Quality Verification', limit: 40 },
        { page: 'home', section: 'Process', key: 'step3_desc', val: 'Rigorous quality checks and samples', limit: 100 },
        { page: 'home', section: 'Process', key: 'step4_title', val: 'Documentation', limit: 40 },
        { page: 'home', section: 'Process', key: 'step4_desc', val: 'Complete export compliance handling', limit: 100 },
        { page: 'home', section: 'Process', key: 'step5_title', val: 'Global Shipping', limit: 40 },
        { page: 'home', section: 'Process', key: 'step5_desc', val: 'Reliable logistics to your destination', limit: 100 },

        { page: 'home', section: 'CTA', key: 'title', val: 'Ready to Source from India?', limit: 80 },
        { page: 'home', section: 'CTA', key: 'desc', val: "Let's discuss your requirements. Our sourcing team is ready to help you find the right products at the right price.", limit: 250 },

        // ABOUT PAGE
        { page: 'about', section: 'Hero', key: 'title', val: 'About ABC International', limit: 60 },
        { page: 'about', section: 'Hero', key: 'desc', val: 'Your trusted partner for high-quality sourcing and global export support from India.', limit: 150 },
        ...
        // CONTACT PAGE
        { page: 'contact', section: 'Hero', key: 'title', val: 'Get in Touch', limit: 40 },
        { page: 'contact', section: 'Hero', key: 'desc', val: 'Ready to start sourcing from India? Contact our team to discuss your requirements.', limit: 150 },
        { page: 'contact', section: 'Info', key: 'email', val: 'info@abc-international.co.in', limit: 60 },
        { page: 'contact', section: 'Info', key: 'phone', val: '+91 XXXX XXXXXX', limit: 40 },
        { page: 'contact', section: 'Info', key: 'address', val: 'Mumbai, Maharashtra, India', limit: 100 },
        { page: 'contact', section: 'Stats', key: 'res_time', val: '24h', limit: 20 },
        { page: 'contact', section: 'Stats', key: 'res_desc', val: 'Average response time', limit: 60 },
        { page: 'contact', section: 'Stats', key: 'countries', val: '100+', limit: 20 },
        { page: 'contact', section: 'Stats', key: 'countries_desc', val: 'Countries served', limit: 60 },
        { page: 'contact', section: 'Stats', key: 'suppliers', val: '1000+', limit: 20 },
        { page: 'contact', section: 'Stats', key: 'suppliers_desc', val: 'Verified suppliers', limit: 60 },
