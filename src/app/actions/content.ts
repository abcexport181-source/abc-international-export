...
export async function upsertSiteContent(updates: { 
  ...
  try {
    const dataToUpsert = updates.map(u => {
      ...
      } else if (u.page_name === 'quality-packaging') {
        const qualityPackagingLimits: Record<string, number> = {
          'Hero.title': 150,
          'Hero.desc': 320,
          'Inspection.title': 150,
          'Inspection.item1_title': 80,
          'Inspection.item1_desc': 240,
          'Inspection.item2_title': 80,
          'Inspection.item2_desc': 240,
          'Inspection.item3_title': 80,
          'Inspection.item3_desc': 240,
          'Inspection.item4_title': 80,
          'Inspection.item4_desc': 240,
          'Standards.title': 150,
          'Standards.desc': 320,
          'Standards.item1': 120,
          'Standards.item2': 120,
          ...
          'Solutions.item4_title': 80,
          'Solutions.item4_desc': 240,
          'Options.title': 150,
          'Options.desc': 240,
          'Options.type1_title': 120,
          'Options.type1_tag1': 120,
          'Options.type1_tag2': 120,
          'Options.type1_tag3': 120,
          'Options.type1_tag4': 120,
          'Options.type1_tag5': 120,
          'Options.type2_title': 120,
          'Options.type2_tag1': 120,
          'Options.type2_tag2': 120,
          'Options.type2_tag3': 120,
          'Options.type2_tag4': 120,
          'Options.type2_tag5': 120,
          'Options.type3_title': 120,
          'Options.type3_tag1': 120,
          ...
          'Sustainable.item1_desc': 240,
          'Sustainable.item2_title': 120,
